...
columns = ['ensemble', 'reinfo', 'pred_term', 'profit_rates', 'std', 'profit_product']
...
def main():
    ...
    profit_rates = profits.cumsum() / (closes.mean()*250000*0.078) + 1 #8000000 + 1
    close_rates = (np.array(closes) - closes[0])/(closes.mean()*0.078) + 1 #*250000/8000000 + 1
    ...
    return dates, closes, profits, close_rates, profit_rates, np.array(profit_sum).std(), profit_product, ensemble_models, path
    ...
    for th in [0.5, 0.4, 0.3]:
        ...
        for pred_term in [7, 6, 5, 4, 3, 2]:
            ...
            for enm in models:
                ...
                dates, closes, profits, close_rates, profit_rates, std, profit_product, ensemble_models, path = main()
                ...
                print("ensemble " + str(ensemble_models) + " 결과")
                print("self-reflection " + str(et.reinfo_th))
                print("pred_term " + str(et.pred_term))
