...
def create_ensembles():
    ...
    result_path = "all_ensemble_results/all_ensemble_results_"+term+"_losscut"+str(ep.profit.loss_cut)+".csv"
    best_model_path = "best_model/best_model_"+term+"_losscut"+str(ep.profit.loss_cut)+".csv"
    ...
    selected_models = get_best_ensemble(result_path, models)
    print('best ensemble')
    print(selected_models)
    selected_models.append(str(ep.reinfo_th) + "_" + str(ep.profit.loss_cut))
    df.append(selected_models)

    pd.DataFrame(np.array((df))).to_csv(best_model_path, index=False, encoding='euc-kr')
