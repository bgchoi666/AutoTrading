...
eval_arr = pd.read_csv("eval_reflection_2022-01-01~2023-03-24_losscut0.01.csv", encoding='euc-kr').values[:, :5]
...
def predict():
    ...
    for i in range(selected_num):
        ...
        et.selected_checkpoint_path = [last_train + "/60M_" + et.selected_model_types[j] + "_best" for j in
