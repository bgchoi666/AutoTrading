...
term = "ensemble(all45)_2022-01-01~2023-03-15"
ep.eval_arr = pd.read_csv("all_ensemble_results_2022-04-01~2023-04-06_20C_reinfo0.4_losscut0.01.csv", encoding='euc-kr').values[:, :5]
ep.reinfo_th = 0.4
ep.pred_term = 20
