...
import make_reinfo_profit_comp as mr
et.mr = mr
et.tm.mr = mr

term = "profit_sum_2022-01-01~2022-11-15"
...
def main():
    ...
    if et.trading_9h:
        path = "9시시가에거래_ensemble_" + str(et.pred_term) + "_reinfo_" + str(et.reinfo_th) + "_" + str(et.pred_term) + "_" + ensemble_models + ".xlsx"
    else:
        path = "9시거래없음_ensemble_" + str(et.pred_term) + "_reinfo_" + str(et.reinfo_th) + "_" + str(et.pred_term) + "_" + ensemble_models + ".xlsx"
    ...
    return dates, profits, closes, profit_rates, [path, profit_sum/length, profit_product], ensemble_models
...
if __name__ == '__main__':
    ...
    for th in [0.3, 0.4, 0.5, 0.6, 0.7]:
        ...
        for pred_term in pred_terms:
            ...
            #ensembles = [['5C', '5P', '10C'], ['5C', '5P', '25C'], ['5C', '20C', '30HL'],
            #            ]
            ensembles = [['5HL', '25HL', '25C'], ['15P', '20C', '25C'], ['20C', '25C', '25P'], ['5HL', '25C', '25P']
                         ]
            for enm in ensembles:
                ...
                dates, profits, closes, profit_rates, summary, ensemble_models = main()

                result_path = 'best_' + term + '_losscut' + str(et.profit.loss_cut) + '.csv'
                ...
                results.append([th, pred_term, ensemble_models, profit_rates[-1],summary[1], summary[2]])
                ...
                if profit_rates[-1] > best[0]:
                    ...
                    pd.DataFrame(dic).to_excel(summary[0], index=False, encoding='euc-kr')
