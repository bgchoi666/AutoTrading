...
start_time = '2023/02/01/09:00'
end_time = '2023/02/15/15:00'
...
reinfo_th = 0.4
model_reinfo_th = 0.4
selected_model_types = ['20C', '25C', '5P']
...
if __name__ == "__main__":
    ...
    end_time = datetime.datetime.now().strftime("%Y/%m/%d/%H:%M")
    start_time = (datetime.datetime.strptime(end_time, '%Y/%m/%d/%H:%M') - datetime.timedelta(days=15)).strftime("%Y/%m/%d/09:00")
