...
end_times = [
    ...
    '2023/09/15/15:00', '2023/09/30/15:00', '2023/10/05/15:00', '2023/10/20/15:00',
...
selected_model_types = ["15P", "25C", "30P"]

et.pred_term = 20
et.reinfo_th = 0.3
et.model_reinfo_th = 0.3

hit_ratios = [0.3, 0.4, 0.5]
eval_terms = [10, 20, 30, 40]

# 랜덤으로 선택한 모델 설정을 기간내 고정 적용
...
["10P", "20C", "20HL", 0.29, 30],
["10HL", "40HL", "5C", 0.08, 5],
["25C", "25HL", "5P", 0.43, 40],
["10HL", "15C", "15HL", 0.08, 5],
["10HL", "15P", "20P", 0.14, 40],
["10HL", "25C", "5C", 0.35, 5],
["15HL", "25C", "5HL", 0.21, 30],
["20HL", "40P", "5P", 0.23, 30],
["10HL", "15C", "20C", 0.08, 10],
["20C", "20HL", "25HL", 0.27, 10],
["25P", "30P", "5C", 0.37, 40],
["10C", "20HL", "5HL", 0.43, 5],
["20C", "40HL", "40P", 0.32, 20],
["10HL", "25C", "25HL", 0.34, 35],
["10P", "15P", "20P", 0.33, 10],
["10HL", "15HL", "40P", 0.13, 5],
["25P", "40C", "40P", 0.37, 15],
["15C", "5HL", "5P", 0.33, 40],
["10P", "25C", "30HL", 0.21, 35],
["10HL", "15C", "30HL", 0.4, 15],
...
if every_term_random:
    ...
    add_txt = "_reinof2_04월26일_2020제외"
...
def main():
    ...
    for i in range(len(last_trains)):
        ...
        if every_term_random:
            ...
            et.ensembles = sorted(random.sample(model_pools, et.selected_num))
    ...
    ensemble_models = ""
    for i in range(len(et.ensembles)):
    ...
    return dates, closes, close_rates, profit_rates, calc_MDD(profit_rates), profit_product, ensemble_models, path
...
if __name__ == '__main__':
    ...
    if not every_term_random:
        ...
        for enm in models:
            ...
            print([ensemble_models, et.reinfo_th, et.pred_term, profit_rates[-1], MDD, profit_product])
