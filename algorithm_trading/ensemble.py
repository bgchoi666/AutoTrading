...
start_time = '2023/11/16/09:00'
end_time = '2023/12/01/15:00'
...
# 2023-12-01 test
#last_train = '2023-11-30'
#import make_reinfo as mr
#pred_term = 10
#reinfo_th = 0.22
#model_reinfo_th = 0.22
#ensembles = ['10HL', '20HL', '40C']
...
pred_term = 40
reinfo_th = 0.37
model_reinfo_th = 0.37
ensembles = ['20P', '25HL', '5P']
