...
#    '2022/03/15/15:00', '2022/03/31/15:00', '2022/02/15/15:00', '2022/02/28/15:00',
end_times = [
    ...
    '2023/03/15/15:00', '2023/03/31/15:00', '2023/04/07/15:00',
]


ep.trading_9h = False

term = "ensemble(all45)_2022-04-01~2023-04-07"
ep.eval_arr = pd.read_csv("all_ensemble_results_2022-04-01~2023-04-06_20C_reinfo0.5.csv", encoding='euc-kr').values[:, :5]
ep.reinfo_th = 0.5
ep.pred_term = 20
...
def create_ensembles():
    ...
    for i in range(14190):
        ensembles = random.sample([j for j in range(45)], ep.selected_num)
