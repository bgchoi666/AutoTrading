...
term = "profit_sum_2022-01-01~2022-11-11"
...
def main():
    ...
    for i in range(et.selected_num):
        ensemble_models += et.ensembles[i] + "_"

    if et.trading_9h:
        path = "9시시가에거래_ensemble_" + str(et.pred_term) + "_reinfo_" + str(et.reinfo_th) + "_" + ensemble_models + ".xlsx"
    else:
        path = "9시거래없음_ensemble_" + str(et.pred_term) + "_reinfo_" + str(et.reinfo_th) + "_" + ensemble_models + ".xlsx"
    ...
    for th in [0.3, 0.4, 0.5, 0.6, 0.7]:
        ...
        for pred_term in pred_terms:
            ...
            ensembles = [
                         ['20C', '5C', '5HL', '10P', '25HL'],
                         ['5C', '10P', '20HL', '30C', '40P'],
                         ["20P", "40HL", "30P"], #reinfo 0.5 2017~2022-08-12 best, reinfo 0.3 2022년 1.3
                         ["10P", "40HL", "20C"],
                         ["5P", "20P", "10HL"],
                         ['25P', '20C', '25C'],
                         ['10C', '20P', '40HL'],
                         ...
                         ['40HL', '10C', '20P', '30P', '15C'],
                        ]

            for enm in ensembles:

                et.ensembles = enm
                et.selected_num = len(enm)
                et.reinfo_th = th
