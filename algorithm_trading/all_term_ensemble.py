...
# 기간별 추천 앙상블의 수익률 생성
# reinfo, pred_term의 값은 주어진 set의 모든 조합으로 부터 주어짐
...
end_times = [
    ...
    '2023/11/15/15:00', '2023/11/24/15:00', '2023/12/15/15:00', '2023/12/31/15:00',
]
...
folder = "앙상블실험/앙상블실험_" + term + "_losscut0.01/"
...
def main():
    ...
    close_rates = (np.array(closes) - closes[0]) / closes[0] / 0.078 + 1#(np.array(closes) - closes[0]) * 250000 / 8000000 + 1
    ...
    return dates, closes, close_rates, profits_rates, [path, MDD, profit_product], ensemble_models
...
if __name__ == "__main__":
    result_path = "eval_reflection/eval_reflection_" + term + "_losscut0.01.csv"
    ...
    for th in [0.2, 0.3, 0.4, 0.5]:
        for pred_term in [10, 20, 30, 40]:
            for enm in ensembles:
                ...
                print("profit rates, std, profit_product, ensemble: ", profit_rates[-1], profits[1], profits[2], enm)
