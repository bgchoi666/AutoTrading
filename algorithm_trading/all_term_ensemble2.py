...
end_times = [
    ...
    '2023/09/15/15:00', '2023/09/25/15:00', '2023/10/15/15:00', '2023/10/31/15:00',
...
pred_term = 40
reinfo_th = 0.35
model_reinfo_th = 0.35
ensembles = ['10P', '20HL', '5HL']

#10C_10HL_10P_	0.4	30	92.68077717 (194)
#20HL_30HL_40P_	0.4	30	56.72327339 (70)

#25C_30C_5P_	0.3	10 359 X 5.71
#15P_25C_40P_	0.4	10 64 X 3.3
#20C_25C_30C_	0.3	40 44 X 6.32
#15C_15P_25C_	0.4	10 33 X 2.95
#20C_30HL_5HL_	0.3	10	8.777864943	0.292411844	245 X 4.97
#10P_15P_20HL_	0.3	10	9.187474422	0.29689993	4.58
#10C_15P_40P_	0.5	10	8.403120133	0.216874276	2.26
...
#folder = "앙상블실험2/앙상블실험_" + term + "_losscut0.01/"
...
def main():
    ...
    for i in range(len(last_trains)):
        ...
        if every_term_random:
            ...
            et.pred_term = random.sample([10, 20, 30, 40], 1)[0]
    ...
    return dates, closes, close_rates, profits_rates, [path, np.array(profit_sum).std(), profit_product], ensemble_models

if __name__ == "__main__":
    result_path = "eval_reflection2/eval_reflection_" + term + "_losscut0.01.csv"
