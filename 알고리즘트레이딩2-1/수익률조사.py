...
a = datetime.datetime.strptime(first_start, "%Y/%m/%d/09:00").strftime("%Y-%m-%d")
df = df.loc[df['최근탐색기간'] >= datetime.datetime.strptime(first_start, "%Y/%m/%d/09:00").strftime("%Y-%m-%d")]
