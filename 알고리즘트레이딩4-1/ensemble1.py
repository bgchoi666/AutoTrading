...
# 04월 17일
data.set_start_end_time(conf, '2024/04/01/09:00', '2024/04/17/15:00', '2024-03-31')
data.set_path(conf)
data.set_target_type(conf, 'C')
data.set_pred_term(conf, 21)
...
if __name__ == "__main__":
    ...
    #prediction only
    conf.gubun = 0
    conf.result_path = 'pred_88_results1.csv'
