...
def create_losscut(ensembles, start, end, last_train):
    ...
    if ep_proc:
        ep.last_trains, ep.start_times, ep.end_times, ep.term = ep.set_term(conf, ep.last_trains, ep.start_times, ep.end_times, "_reinfo2")
...
if __name__ == "__main__":
    ...
    model, profit, losscut = create_losscut(ensembles, start_time, end_time, last_train)
    print(model, profit, losscut)