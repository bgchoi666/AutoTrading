...
class config:
    ...
    result_path = last_train + '/pred_88_results.csv'  # 예측 결과 손익 파일
...
def set_path(conf):
    conf.df0_path = 'kospi200f_11_60M.csv' # 원본 파일
    ...
    conf.result_path = conf.last_train+'/pred_88_results.csv' # 예측 결과 손익 파일
