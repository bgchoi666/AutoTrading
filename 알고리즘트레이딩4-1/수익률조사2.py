...
if mode == 'mr2':
    ...
    #df = df.loc[df['알고리즘'] == '알4-1_random1년_2년'].reset_index(drop=True)
    #df = df.loc[df['알고리즘'] == '알4-1_1년_2년_mr3'].reset_index(drop=True)

#df = df.loc[df['알고리즘'] == '알4-1_1년_2년'].reset_index(drop=True)
