...
def ensemble_predict(loss_cut):
    ...
    conf.result_path = conf.last_train + "/pred_89_results.csv"
    conf.gubun = 0
...
def create_losscut(model, start, end, last_train):
...
if __name__ == "__main__":
    ...
    ensembles = [
        ...
        ["15P", "40P", "5P", 0.5, 5, 65, 0.005]

    ]
    start_time = '2025/04/14/09:00'
    end_time = '2025/06/13/15:00'
    last_train = '2025-05-31'
