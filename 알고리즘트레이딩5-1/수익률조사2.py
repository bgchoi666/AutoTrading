...
if mode == 'mr2':
    df = df.loc[df['알고리즘'] == '알5-1_random3개월_6개월_12개월_mr2'].reset_index(drop=True)
    #df = df.loc[df['알고리즘'] == '알5-1_1년_2년_mr2'].reset_index(drop=True)

    #df = pd.concat([df1, df2], axis=0).reset_index(drop=True)
else:
    df = df.loc[df['알고리즘'] == '알5-1_random3개월_6개월_12개월_mr3'].reset_index(drop=True)
    #df = df.loc[df['알고리즘'] == '알5-1_1년_2년_mr3'].reset_index(drop=True)
