...
if mode == 'mr2':
    df1 = df.loc[df['알고리즘'] == '알5-1_random3개월_6개월_12개월_mr2'].reset_index(drop=True)
    df2 = df.loc[df['알고리즘'] == '알5-1_random3개월_6개월_12개월'].reset_index(drop=True)
    #df1 = df.loc[df['알고리즘'] == '알2-1_random1년_2년'].reset_index(drop=True)
    #df2 = df.loc[df['알고리즘'] == '알2-1_1년_2년'].reset_index(drop=True)
